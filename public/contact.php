...
<head>
    ...
    <title>Contact - Ilyass Fitness</title>
</head>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="contact-card instagram-card">
                        ...
                        <div class="contact-details">
                            <h3>Instagram</h3>
                            <a href="https://www.instagram.com/ilyass_fitness_/" target="_blank"
                ...
                <div class="col-md-4">
                    <div class="contact-card">
                        ...
                        <div class="contact-details">
                            <h3>Email</h3>
                            <a href="mailto:ILYASSFIT@GMAIL.COM">
                                ILYASSFIT@GMAIL.COM
                            </a>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="contact-image-wrapper">
                        <img src="assets/images/static/contact_img1.jpg" alt="Fitness Training" class="contact-image">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="contact-form-wrapper">
                        ...
                        <form id="contactForm">
                            ...
                            <div class="mb-3">
                                <input type="tel" class="form-control" name="telephone" placeholder="Your Phone Number"
                                    required>
                            </div>
